          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Create visually appealing and user-friendly designs. We craft
                engaging experiences that keep your audience hooked.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Get a stunning, high-performance website designed for your
                business. Responsive, fast, and built for success.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Speed & Security Optimization</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Keep your website running fast and secure. Performance tuning,
                security updates, and ongoing maintenance made easy.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Launch your online store with a seamless shopping experience.
                Secure, scalable, and designed for conversions.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
